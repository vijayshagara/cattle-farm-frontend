...
//   // fallback image if cow.image is not available
//   const cowImage =
//     cow.image ||
...
//       ) : (
//         <>
//           <h5 className="fw-bold">{cow.name}</h5>
//           <p className="mb-1 text-muted">Breed: {cow.breed}</p>
//           <p className="mb-2 text-muted">Gender: {cow.gender}</p>
...
//               onClick={() => dispatch(deleteCow(cow.id))}
//             >
//               Delete
//             </button>
//           </div>
...
export default function CowCard({ cow }) {
  ...
  return (
    <div
      className="card p-3 h-100 shadow-sm cow-card"
    ...
    >
      ...
      <h5 className="fw-bold mb-1">{cow.name}</h5>
      <p className="text-muted mb-1">Breed: {cow.breed}</p>
      <p className="text-muted mb-0">Gender: {cow.gender}</p>
    </div>
  );
}
